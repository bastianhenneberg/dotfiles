(custom-set-variables
 ...
 '(package-selected-packages '(org-modern multi-vterm ob-mermaid emmet-mode)))
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :foreground "#8bd5ca" :height 1.15))))
 ...
 '(org-todo ((t (:foreground "cornflowerblue" :weight bold)))))
